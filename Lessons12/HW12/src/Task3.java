...
//                // если currentNumber повторяется, значит мы уже посчитали количество его повторений ранее
//                // записываем в alreadyCounted значение true, что бы не считать еще раз и не выводить результат в консоль
//                /*
//                Пример:
